    ...
    (SELECT   i.item_id
     ...
     ,        CASE
              ...
              ELSE  
			      ...
			      END
              END AS amount
     ,        (SELECT system_user_id FROM system_user WHERE system_user_name = 'DBA1') AS created_by
     ,        (TRUNC(SYSDATE)) AS creation_date
     ,        (SELECT system_user_id FROM system_user WHERE system_user_name = 'DBA1') AS last_updated_by
